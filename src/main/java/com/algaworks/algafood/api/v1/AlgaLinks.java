...
public class AlgaLinks {
	...
	public Link linkToModelo(Long modeloId, String rel) {
		return linkTo(methodOn(ModeloController.class)
				.buscar(modeloId)).withRel(rel);
	}
	
	public Link linkToModelo(Long modeloId) {
		return linkToModelo(modeloId, IanaLinkRelations.SELF.value());
	}

	
	public Link linkToModelos(String rel) {
		return linkTo(ModeloController.class).withRel(rel);
	}
	
	public Link linkToModelos() {
		return linkToModelos(IanaLinkRelations.SELF.value());
	}
	...
	public Link linkToMeioTransporte(Long meioTransporteId, String rel) {
		return linkTo(methodOn(MeioTransporteController.class)
				.buscar(meioTransporteId)).withRel(rel);
	}
	
	public Link linkToMeioTransporte(Long meioTransporteId) {
		return linkToMeioTransporte(meioTransporteId, IanaLinkRelations.SELF.value());
	}
	
	public Link linkToMeioTransportes(String rel) {
		return linkTo(MeioTransporteController.class).withRel(rel);
	}
	
	public Link linkToFuncionarios(String rel) {
		return linkTo(FuncionarioController.class).withRel(rel);
	}
	
	public Link linkToMeioTransportes() {
		return linkToMeioTransportes(IanaLinkRelations.SELF.value());
	}
	
	public Link linkToFuncionarios() {
		return linkToFuncionarios(IanaLinkRelations.SELF.value());
	}
