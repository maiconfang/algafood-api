...
public @interface CheckSecurity {
	...
	public @interface Modelos {
		...
		@PreAuthorize("hasAuthority('SCOPE_WRITE') and hasAuthority('EDITAR_MODELOS')")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeEditar { }

		@PreAuthorize("@algaSecurity.podeConsultarModelos()")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeConsultar { }
	...
	public @interface MeiosTransporte {
		
		@PreAuthorize("hasAuthority('SCOPE_WRITE') and hasAuthority('EDITAR_MEIOS_TRANSPORTE')")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeEditar { }

		@PreAuthorize("@algaSecurity.podeConsultarMeiosTransporte()")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeConsultar { }
	...
	public @interface Funcionarios {
		...
		@PreAuthorize("hasAuthority('SCOPE_WRITE') and hasAuthority('EDITAR_FUNCIONARIOS')")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeEditar { }

		@PreAuthorize("@algaSecurity.podeConsultarFuncionarios()")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeConsultar { }
